...
class Base(models.AbstractModel):
    ...
    def _init_constraints_onchanges(cls):
        super(Base, cls)._init_constraints_onchanges()
    ...
    def tracked_fields(self):
        return self.env.context.get('fieldchange_recompute', True) and list(self._get_tracked_fields_recordchange()) or []

    # def createssss(self, vals):
