...
if __name__=="__main__":
    fdbcon=FPBXDBConnector()
    fdbcon.connect()

    print(fdbcon.show_extension(89))
    fdbcon.add_user(extension=299,password="994885776622374",outboundcid="49894161488729 <49894161488729>",displayname="TestUser<AUTOGEN>")
    fdbcon.add_extension(account=299,secret="029398483293458858492jdjdjjshreuf")
    print("##########################")
    print(fdbcon.show_extension(299))
    fdbcon.add_inbound_route(ir_source="4989215444395", ir_target="from-did-direct,299,1", rule_name="299<Autogen>")

    fdbcon.apply_db_changes()